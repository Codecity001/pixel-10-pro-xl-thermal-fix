# Pixel 10 Thermal Polling Fix v1.4.0-universal-test.2

Public universal test prerelease.

This release supersedes `v1.4.0-universal-test.1`, whose ZIP contained profiles but did not materialize the selected profile into active `system/vendor/etc` during install on Mustang staging.
...
- Source: `tag:v1.4.0-universal-test.1:profiles/blazer`.
