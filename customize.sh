...
ui_print "Bisect v5 scope: live-stock thermal_info_config_throttling.json only"
ui_print "Changed sensor: VIRTUAL-SKIN-CPU-LIGHT-ODPM + VIRTUAL-SKIN-CPU-ODPM + VIRTUAL-SKIN-CPU-MID PollingDelay 300000ms -> 5000ms"
