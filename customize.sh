...
[ -n "$MODULE_VERSION" ] || MODULE_VERSION="1.5.1-universal-test.1"
[ -n "$MODULE_VERSION_CODE" ] || MODULE_VERSION_CODE="1016101"
...
ui_print "Prerelease 1.5.1 test.1; stable updateJson remains 1.5-universal.1"
