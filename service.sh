...

{
  ...
  echo "scope=thermal_info_config_throttling.json:VIRTUAL-SKIN,VIRTUAL-SKIN-HINT,VIRTUAL-SKIN-CPU-LIGHT-ODPM,VIRTUAL-SKIN-CPU-ODPM,VIRTUAL-SKIN-CPU-MID,VIRTUAL-SKIN-CPU-HIGH,VIRTUAL-SKIN-SOC"
